---
title: Phase 2 — Classical ML Core
tags: [design-doc]
sources: []
...
- REQ-3: k-Nearest Neighbors classifier and regressor in `ferrolearn-linear` (or a new `ferrolearn-neighbors`) with ball tree and KD-tree spatial indexing backends
- REQ-4: Gaussian, Multinomial, Bernoulli, and Complement Naive Bayes variants in a new `ferrolearn-bayes` crate (or `ferrolearn-linear`)
