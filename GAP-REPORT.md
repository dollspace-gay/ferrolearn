...
- Test evidence: the current tree contains 348 `tests/divergence_*.rs` files.
...
- Scoped ML-facing sklearn API gaps: 49 exact public items missing across the
