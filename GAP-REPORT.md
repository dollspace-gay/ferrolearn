...
- Test evidence: the current tree contains 347 `tests/divergence_*.rs` files.
...
- Scoped ML-facing sklearn API gaps: 50 exact public items missing across the
