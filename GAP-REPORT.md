...
- Test evidence: the current tree contains 351 `tests/divergence_*.rs` files.
...
- Scoped ML-facing sklearn API gaps: 41 exact public items missing across the
