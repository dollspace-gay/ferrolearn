...
- Test evidence: the current tree contains 349 `tests/divergence_*.rs` files.
...
- Scoped ML-facing sklearn API gaps: 47 exact public items missing across the
...
| `sklearn.gaussian_process.kernels` | `CompoundKernel`, `ExpSineSquared`, `Exponentiation`, `Hyperparameter` |
