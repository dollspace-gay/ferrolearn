...
- Test evidence: the current tree contains 350 `tests/divergence_*.rs` files.
...
- Scoped ML-facing sklearn API gaps: 42 exact public items missing across the
...
| `sklearn.kernel_approximation` | `PolynomialCountSketch`, `SkewedChi2Sampler` |
...
`sklearn.gaussian_process`, `sklearn.gaussian_process.kernels`, `sklearn.covariance`,
