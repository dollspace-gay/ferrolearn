...
- Scoped ML-facing sklearn API gaps: 85 exact public items missing across the
...
| `sklearn.cluster` | `SpectralBiclustering`, `SpectralCoclustering`, `cluster_optics_xi`, `compute_optics_graph`, `ward_tree` |
