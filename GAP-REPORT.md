...
- Test evidence: the current tree contains 330 `tests/divergence_*.rs` files.
...
- Scoped ML-facing sklearn API gaps: 73 exact public items missing across the
...
|---|---|
| `sklearn.linear_model` | `PassiveAggressiveClassifier`, `LarsCV`, `LassoLarsCV`, `LassoLarsIC`, `TheilSenRegressor`, `PassiveAggressiveRegressor` |
