...
//! | REQ-7 | `GenericUnivariateSelect` (mode meta-selector) | SHIPPED (scoped) / residual open | sibling [`crate::GenericUnivariateSelect`] dispatches percentile/k_best/fpr/fdr/fwe for dense `f_classif`; full callable/sparse/Python protocol residuals remain blocker #1429 |
