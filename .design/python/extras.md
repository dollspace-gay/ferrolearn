...
| 26 | `DBSCAN` | `RsDBSCAN` (hand) | `ferrolearn_cluster::FittedDBSCAN` | fit(`sample_weight`)/`labels_`/`core_sample_indices_`/`components_` | clusterer + **Pos-fix** |
