...
fn fixture() -> Array2<f64> {
    array![
        [0.496714153011, -0.138264301171, 0.647688538101, 1.523029856408, -0.234153374723],
        [-0.234136956949, 1.579212815507, 0.767434729153, -0.469474385935, 0.542560043586],
        [-0.463417692812, -0.465729753570, 0.241962271566, -1.913280244658, -1.724917832513],
        [-0.562287529241, -1.012831120334, 0.314247332595, -0.908024075521, -1.412303701335],
        [1.465648768922, -0.225776300487, 0.067528204688, -1.424748186213, -0.544382724525],
        [0.110922589710, -1.150993577422, 0.375698018346, -0.600638689919, -0.291693749793],
        [-0.601706612229, 1.852278184509, -0.013497224738, -1.057710928956, 0.822544912103],
        [-1.220843649971, 0.208863595005, -1.959670123880, -1.328186048898, 0.196861235869],
        [0.738466579995, 0.171368281190, -0.115648282388, -0.301103695589, -1.478521990367],
        [-0.719844208395, -0.460638770960, 1.057122226219, 0.343618289568, -1.763040155363],
        [0.324083969395, -0.385082280416, -0.676922000306, 0.611676288841, 1.030999522496],
        [0.931280119116, -0.839217523223, -0.309212375851, 0.331263431404, 0.975545127122],
        [-0.479174237845, -0.185658976664, -1.106334974006, -1.196206624081, 0.812525822394],
        [1.356240028571, -0.072010121580, 1.003532897892, 0.361636025048, -0.645119754605],
        [0.361395605508, 1.538036566466, -0.035826039110, 1.564643655814, -2.619745104090],
        [0.821902504375, 0.087047068238, -0.299007350466, 0.091760776536, -1.987568914601],
        [-0.219671887838, 0.357112571512, 1.477894044742, -0.518270218274, -0.808493602893],
        [-0.501757043585, 0.915402117702, 0.328751109660, -0.529760203767, 0.513267433113],
        [0.097077549348, 0.968644990533, -0.702053093877, -0.327662146598, -0.392108153132],
        [-1.463514948132, 0.296120277065, 0.261055272180, 0.005113456642, -0.234587133375]
    ]
}
...
const SK_COMPONENTS: [[f64; 5]; 3] = [
    [-0.2719106452, 0.1205454777, -0.3913343135, -0.4298222842, 0.7573926643],
    [0.3127223204, 0.301967885, 0.0933154904, 0.7261018314, 0.5244887953],
    [-0.4342979184, 0.850086047, 0.2090483171, -0.0432758243, -0.2077619671],
];
#[allow(clippy::excessive_precision, reason = "live sklearn 1.5.2 oracle (R-CHAR-3)")]
...
#[allow(clippy::excessive_precision, reason = "live sklearn 1.5.2 oracle (R-CHAR-3)")]
const SK_MEAN: [f64; 5] = [0.011868855, 0.1518941871, 0.066237159, -0.2871161834, -0.4621166047];
#[allow(clippy::excessive_precision, reason = "live sklearn 1.5.2 oracle (R-CHAR-3)")]
const SK_VAR: [f64; 5] = [0.6102427073, 0.6821506344, 0.5961971503, 0.8008722733, 1.12348117];
...
/// Tracking: #2386
#[test]
#[ignore = "divergence: multi-batch components_ off by ~1.4e-2 vs sklearn; tracking #2386"]
...
/// Tracking: #2386
#[test]
#[ignore = "divergence: multi-batch singular_values_ off by ~1e-3 vs sklearn; tracking #2386"]
...
/// Tracking: #2386
#[test]
#[ignore = "divergence: multi-batch explained_variance_ off by ~4e-4 vs sklearn; tracking #2386"]
...
/// Tracking: #2386
#[test]
#[ignore = "divergence: multi-batch explained_variance_ratio_ off by ~1e-4 vs sklearn; tracking #2386"]
...
/// Tracking: #2386
#[test]
#[ignore = "divergence: multi-batch transform off by ~2.9e-3 vs sklearn; tracking #2386"]
