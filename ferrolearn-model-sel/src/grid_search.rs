...
//! | REQ-DEFAULT-CV (default cv=None ⇒ 5-fold classifier-aware) | NOT-STARTED | `cv` mandatory; this driver does not yet consume `check_cv` / StratifiedKFold default dispatch (`:928`). Blocker #1779. |
