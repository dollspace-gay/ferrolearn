...
//! | REQ-5 (default cv: 5-fold + classifier-aware StratifiedKFold/KFold) | NOT-STARTED | `cv: &dyn CrossValidator` is mandatory; this driver does not yet consume `check_cv` default / `is_classifier` dispatch (`:2286`, `:2206-2214`). Blocker #1757. |
