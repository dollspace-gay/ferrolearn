...
const X_FLAT: [f64; 100] = [
    0.4967141530112327, -1.3826430117118464, 0.32384426905034625, 4.569089569224076,
    -0.46830674944667194, -0.23413695694918055, 15.792128155073915, 0.3837173645764544,
    -1.4084231578048563, 1.0851200871719293, -0.46341769281246226, -4.657297535702568,
    0.12098113578301706, -5.739840733973393, -3.4498356650260655, -0.5622875292409727,
    -10.128311203344238, 0.15712366629763694, -2.724072226563633, -2.824607402670583,
    1.465648768921554, -2.2577630048653567, 0.03376410234396192, -4.274244558640371,
    -1.0887654490503653, 0.11092258970986608, -11.509935774223027, 0.18784900917283598,
    -1.801916069756415, -0.5833874995865536, -0.6017066122293969, 18.522781845089376,
    -0.0067486123689669605, -3.173132786867701, 1.645089824206378, -1.2208436499710222,
    2.088635950047554, -0.9798350619398878, -3.9845581466952913, 0.39372247173824704,
    0.7384665799954104, 1.713682811899705, -0.057824141194120264, -0.9033110867678664,
    -2.9570439807348547, -0.7198442083947086, -4.606387709597875, 0.5285611131094579,
    1.0308548687053842, -3.526080310725468, 0.324083969394795, -3.8508228041631654,
    -0.33846100015297936, 1.8350288665226038, 2.061999044991902, 0.9312801191161986,
    -8.392175232226386, -0.1546061879256073, 0.9937902942106919, 1.9510902542447184,
    -0.47917423784528995, -1.8565897666381712, -0.5531674870030141, -3.5886198722420124,
    1.625051644788396, 1.356240028570823, -0.7201012158033384, 0.5017664489460121,
    1.0849080751429026, -1.2902395092102485, 0.36139560550841393, 15.380365664659692,
    -0.01791301955497577, 4.693930967442019, -5.239490208179489, 0.8219025043752238,
    0.8704706823817122, -0.14950367523293373, 0.2752823296065069, -3.9751378292017856,
    -0.21967188783751193, 3.5711257151174642, 0.738947022370758, -1.5548106548209422,
    -1.6169872057863752, -0.5017570435845365, 9.154021177020741, 0.16437555482984223,
    -1.5892806113011164, 1.0265348662267122, 0.09707754934804039, 9.686449905328892,
    -0.3510265469386762, -0.9829864397933046, -0.7842163062643153, -1.4635149481321186,
    2.9612027706457607, 0.13052763608994467, 0.01534036992738267, -0.46917426675029383,
];

const Y: [f64; 20] = [
    23.188644169901533, -33.55035263928976, -2.476771315001646, 17.560579747590857,
    -2.185859585970603, 22.05355804446233, -46.045166050350495, -16.259100740132915,
    1.9374341789044796, 19.776066702729473, 15.546368050815033, 23.203703615260313,
    -7.016778431065476, 13.071583308076502, -4.997001709667257, 8.698497853193157,
    -6.310156757846288, -21.436297204942417, -17.739937102468453, -3.384400400772374,
];
...
fn ridge_f32_parity_alpha10() {
    ...
    let fitted = Ridge::<f32>::new().with_alpha(10.0).fit(&x32, &y32).unwrap();
    let coef = fitted.coefficients();
    for j in 0..5 {
        let diff = (coef[j] - sk_coef[j]).abs();
        assert!(
...
/// Tracking: #392
#[test]
#[ignore = "divergence: Ridge(alpha=0) errors on rank-deficient X; sklearn _ridge.py:753 returns min-norm coef; tracking #392"]
